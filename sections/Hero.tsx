...
const HeroMore: NextPage = () => (
    <div className="w-full flex flex-col items-center absolute bottom-20 md:bottom-8 animate-slideUp">
...
const Hero: NextPage = () => (
    ...
    >
        <div className="w-full flex flex-col-reverse -translate-y-10 lg:flex-row px-14 justify-between">
            <p className="w-full text-2xl text-center my-6 animate-slideUp lg:text-left lg:my-0 lg:mt-10 lg:w-2/3 lg:text-4xl xl:text-5xl 2xl:text-6xl lg:animate-slideRight">
                Zajmuję się tworzeniem aplikacji webowych i mobilnych
            </p>
            <img
                className="w-full lg:w-2/5 animate-slideUp lg:animate-slideLeft"
                src="/assets/hero.svg"
                alt="hero"
            />
        </div>
