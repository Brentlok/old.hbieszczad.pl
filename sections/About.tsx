...
const About: NextPage = () => (
  <section className="flex items-center flex-col w-full lg:w-5/6 m-auto py-16">
    ...
    <div className="flex mt-16">
      <p className="w-full px-4 text-2xl tracking-wider lg:text-3xl lg:w-2/3 lg:px-0 lg:pr-12">
        ...
        porttitor. Suspendisse potenti. Vivamus sollicitudin lobortis volutpat.
        Cras accumsan velit non varius mattis.
      </p>
